...
export default function EditReservationAvailability({
  ...
  return (
    <div className="mt-5 flex flex-col gap-8 text-[#111111] tablet:gap-6">
      <div>
        <label
          htmlFor="reservation-edit-guests"
          className="mb-3 block text-[11px] uppercase tracking-[0.24em] text-[#b48a45] tablet:text-[12px] tablet:tracking-[0.32em]"
        >
          Personnes
        </label>
        <div className="relative w-full tablet:w-[320px] desktop:w-[calc(50%-12px)]">
          <select
      ...
      <div className="flex flex-col gap-8 tablet:gap-6 desktop:flex-row">
        ...
        <div className="relative border border-[#b48a45]/20 bg-white/50 p-4 tablet:w-full tablet:p-6 desktop:w-1/2 desktop:p-7">
          <div className="mb-5 flex items-start justify-between gap-4">
            ...
            {isLoading ? (
              <div className="flex items-center gap-2 text-[13px] text-black/50 tablet:text-[14px]">
                ...
                return (
                  <button
                    ...
                    className={`border px-3 py-3 text-[14px] transition ${
                      isSelected
                        ? "border-[#bb924b] bg-[#bb924b] text-white"
                        : "border-black/10 bg-white text-black hover:border-[#b48a45] hover:text-[#8f6a2c]"
                    }`}
                  >
